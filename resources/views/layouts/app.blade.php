            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li><a class="nav-link" href="{{ route('tag.index') }}">{{ __('messages.tag') }}</a></li>
                        <li><a class="nav-link" href="{{ route('question.index') }}">{{ __('messages.Questions') }}</a></li>
                        <li><a class="nav-link" href="{{ route('reply.show') }}">{{ __('messages.Reply') }}</a></li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                {{ Auth::user()->name }}
                            </a>
                            <ul class="dropdown-menu">
                                <li><a href="{{ route('users.index') }}" class="dropdown-item">{{ __('messages.Users') }}</a></li>
                                <li><a href=" {{ route('roles.index') }}" class="dropdown-item">{{ __('messages.Roles') }}</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('users.profile') }}" class="dropdown-item">{{ __('messages.Profile') }}</a></li>
                        <li> <a class=" dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                                                                document.getElementById('logout-form').submit();">
                                {{ __('messages.Logout') }}
                            </a></li>
