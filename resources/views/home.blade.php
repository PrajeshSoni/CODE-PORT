                ...
                <div class="container py-lg-5">
                    ...
                    <div class="content-info-in row mt-md-5 mt-4">
                        <div class="col-lg-3 col-md-6 imghrs">
                            <a class="imghr" href="#"><img src="{{ asset('img/1.jpg') }}" class="img-fluid"
                                    style="height:320px ;" alt="">
                                <div class="details"><span class="title">Web Development</span><span class="info">Add
                                        Description</span></div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 imghrs">
                            <a class="imghr" href="#"><img src="{{ asset('img/2.jpg') }}" class="img-fluid"
                                    style="height: 320px;;" alt="">
                        ...
                        <div class="col-lg-3 col-md-6 imghrs">
                            <a class="imghr" href="#"><img src="{{ asset('img/lang.jpg') }}" class="img-fluid"
                                    style="height:320px;" alt="">
                                <div class="details"><span class="title">Full-Stack Developement</span><span
                                        class="info">Add
                                        Description</span></div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6 imghrs">
                            <a class="imghr" href="#"><img src="{{ asset('img/4.jpg') }}" class="img-fluid"
                                    style="height:320px ;" alt="">
                                <div class="details"><span class="title"> Computer Programming</span><span
                                        class="info">Add
                                        Description</span></div>
                            </a>
                        </div>
