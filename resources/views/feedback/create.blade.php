                ...
                <form class="f-hnyv mt-md-5 mt-4" action="{{route('feedback.store') }}" method="POST">
                    ...
                    <div class="main-input">
                        <div>
                            ...
                            <input type="text" name="f_name" id="w3lName" placeholder="Your Name" class="contact-input" />
                        </div>
                        <div>
                            <label class="field-info">Email <span class="compulsary">*</span></label>
                            <input type="email" name="f_email" id="w3lSender" placeholder="Your Email id" class="contact-input" required />
                        </div>
