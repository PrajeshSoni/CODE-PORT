...
<div class="wrapper row2">
  <div id="container" class="clear">
    <!-- Slider -->
	<form action="addissuecode.jsp" method="post">
...
out.println("select books");
String nm1;
out.println("<select name=boo>");
while(rs1.next())
{
	nm1=rs1.getString(2);
	out.println("<option value="+nm1+">"+nm1+"</option>");
}
rs.close();
rs1.close();
conn.commit();
