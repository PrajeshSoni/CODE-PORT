...
ResultSet rs=stmt.executeQuery("select * from issueregister where issue_id="+iid+"");
%>
<form action="issueeditcode.jsp" method="post">
...
%>
<tr>
<td colspan="2"><div align="center"><strong>Book Issue Information</strong> </div></td>
</tr>
<tr>
<td width="241">Enter Issue Id </td>
<td width="265"><label>
...
<tr>
<td>Enter Book Id</td>
<td><input type="text" name="t3" value="<%=rs.getInt(3) %>"/></td>
</tr>
<tr>
  <td>Enter Date </td>
